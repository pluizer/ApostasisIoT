...
"(println \"Host: apostasis.eu\" s)"
"(println \"Content-Type: application/x-www-form-urlencoded\" s)"
"(println (concatenate 'string \"Content-Length: \" (i2s (length str))) s)"
"(println \"\" s)"
"(println str s)"
"(println \"\" s)"
...
"(read-line s)))))"
"(defun read-value (key func)"
"(with-client (s \"apostasis.eu\" 80)"
"(println (concatenate 'string \"GET /DesktopModules/InterconnectionFrameworkModule/API/restv1/D1654A27-5fb6-4f6A-986B-979170BD05C8/read/i?key=\" key \" HTTP/1.0\") s)"
"(println \"Host: apostasis.eu\" s)"
...
object *fn_parseint (object* args, object* env) {
  (void) env;
  char* cstr = cstringbuf(first(args));
  String stringObj = String(cstr);
  return number(stringObj.toInt());
}

object *fn_i2s (object* args, object* env) {
  (void) env;
  int i = integer(first(args));
  String str = String(i);
